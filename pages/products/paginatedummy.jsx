...
function Computer({ product }) {
    ...
    document.getElementById(`list${currentPage}`).style.backgroundColor = 'black'
        ...
        <div>
            ...
            <nav aria-label="Page navigation example" className='flex justify-center'>
                <ul className="inline-flex items-center -space-x-px mt-8 ">
                    <li>
                        <a href={`?page=${currentPage - 1}`} className="block py-2 px-3 ml-0 leading-tight text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 ">
                    ...
                    {totalpagesArray.map((item) => {
                        return (
                            ...
                            <li id={`list${item}`} key={`hello?${item}`}>
                                <a href={`?page=${item}`} className="py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700">{item}</a>
                            </li>
                        )
                    })
                    }
                    <li>
                        <a href={`?page=${currentPage + 1}`} className="block py-2 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 ">
