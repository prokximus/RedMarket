	...
	return (
		<>
			<header className="text-black body-font bg-red-300">
				<div className="container mx-auto flex flex-wrap px-5 py-1 justify-between items-center">
					<Link href={"/"}>
					...
					<div className="flex space-x-2 items-center justify-end pr-10 md:pr-4 small:pr-0">
						...
						<button className="transition-all duration-200 inline-flex items-center bg-red-400 border-0 py-1 px-3 focus:outline-none hover:bg-red-500 font-semibold rounded-lg text-base text-white hover:scale-110 hover:rounded-xl">
