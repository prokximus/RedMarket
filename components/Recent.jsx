				...
				<div className="container px-5 py-24 mx-auto">
					...
					<div className="flex flex-wrap justify-center -m-4">
						{product.map((item) => (
							...
							<div className="w-full md:w-1/3 bg-white rounded-lg shadow-md group p-4" key={item.id}>
								<a href="#">
									<picture>
										<img className="lg:h-[320px] transition-all duration-200 h-[240px] py-4 mx-auto object-cover object-center group-hover:scale-110" src={item.img_url} alt="product image" />
									</picture>
								</a>
								<div className="px-5 pb-5">
									...
									<div className="flex items-center mt-2.5 mb-5">
										...
										<span className="bg-red-100 text-red-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded  ml-3">5.0</span>
									</div>
